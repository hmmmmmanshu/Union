...
const steps = [
  {
    image: "/images/phones-pair-1.png",
    icon: (
  ...
  {
    image: "/images/phones-pair-2.png",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    image: "/images/phones-pair-3.png",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <section id="how-it-works" className="bg-[#faf8f5] py-16 md:py-24">
      <div className="section-container">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-3 lg:gap-8">
          {steps.map((step) => (
            <div key={step.image} className="flex flex-col items-center text-center">
